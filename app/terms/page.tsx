  ...
  const sections = [
      ...
      content: (
        <div className="space-y-4">
          <p>
            ...
            <a href="https://mind-clear.com" className="text-[#6B5A20] underline hover:text-[#111111]">mind-clear.com</a>,
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            <strong className="text-[#6B5A20]">Mind Clear Studio LLC</strong> ("we," "us," or "our") is a limited liability company
            organized under the laws of the State of Missouri.
          </p>
          <p>
            <strong className="text-[#6B5A20]">Nature of Business:</strong> The purpose of Mind Clear Studio LLC is to engage in the
      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2 text-[#444444]">
            <li><strong className="text-[#6B5A20]">Registration:</strong> You agree to provide accurate, current, and complete information during the registration process.</li>
            <li><strong className="text-[#6B5A20]">Security:</strong> You are responsible for maintaining the confidentiality of your account credentials (username and password). You are responsible for all activities that occur under your account.</li>
            <li><strong className="text-[#6B5A20]">Eligibility:</strong> You must be at least 13 years old to use our Services. If you are under 18, you may only use the Services with the permission of a parent or guardian who has reviewed and agreed to these Terms on your behalf.</li>
            <li><strong className="text-[#6B5A20]">Termination:</strong> We reserve the right to suspend or terminate your account if you violate these Terms or for any other reason at our sole discretion. Upon account deletion, your data will be processed in accordance with our Privacy Policy. You may delete your account at any time through the app settings or by contacting us.</li>
          </ul>
        </div>
      )
    },
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div>
            <p className="mb-2">
              <strong className="text-[#6B5A20]">Our Content:</strong> The Services and their entire contents, features, and functionality
          ...
          <div>
            <p>
              <strong className="text-[#6B5A20]">User Content:</strong> You retain ownership of any data, text, or other materials you
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <ul className="list-disc pl-6 space-y-2 text-[#444444]">
            <li>
              <strong className="text-[#6B5A20]">Subscriptions:</strong> Some portions of the Services may be available only via a paid
            ...
            <li>
              <strong className="text-[#6B5A20]">Billing:</strong> You agree to provide valid payment information. By submitting such
            ...
            <li>
              <strong className="text-[#6B5A20]">Refunds:</strong> Except when required by law, paid subscription fees are non-refundable.
            ...
            <li>
              <strong className="text-[#6B5A20]">Changes:</strong> We may modify subscription fees at any time. Any subscription fee change
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-lg font-semibold text-[#6B5A20]">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div>
            <p className="mb-2">
              <strong className="text-[#6B5A20]">Governing Law:</strong> All matters relating to the Services and these Terms shall be
          ...
          <div>
            <p className="mb-2">
              <strong className="text-[#6B5A20]">Mediation:</strong> In the event of any dispute, claim, or controversy arising out of or
          ...
          <div>
            <p>
              <strong className="text-[#6B5A20]">Jurisdiction:</strong> Any legal suit, action, or proceeding arising out of, or related
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p>
            <Link href="/privacy" className="text-[#6B5A20] underline hover:text-[#111111] inline-flex items-center gap-1">
    ...
    },
    {
      ...
      content: (
        <p>
          ...
          <Link href="/privacy" className="text-[#6B5A20] underline hover:text-[#111111]">Privacy Policy</Link>.
        </p>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="space-y-2 text-[#444444]">
            <p><strong className="text-[#6B5A20]">Mind Clear Studio LLC</strong></p>
            <p>
              <strong>Email:</strong>{" "}
              <a href="mailto:support@mind-clear.com" className="text-[#6B5A20] underline hover:text-[#111111]">
    ...
    <div className="min-h-screen bg-[#E8E8E2]">
      ...
      <header className="relative py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#F5F1E1] border border-[#DEDCD2] mb-8">
            <FileText className="w-4 h-4 text-[#6B5A20]" />
            <span className="text-sm text-[#444444]">Terms of Service</span>
          </div>

          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-[#111111]">
            Terms of <span className="text-[#6B5A20]">Service</span>
          </h1>
      ...
      <main className="max-w-4xl mx-auto px-6 pb-20">
        <div className="text-sm text-[#6B6B6B] mb-12 text-center">
          <div>Last Updated: <strong className="text-[#111111]">January 11, 2026</strong></div>
        </div>
